    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    UsuarioDAL x = new UsuarioDAL();
                    if(x.usuariopaciente(user.UserName)>0)
                    { 
        ...
        public async Task<ActionResult> Login2(LoginViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                     UsuarioDAL x = new UsuarioDAL();
                    if(x.usuariodoctor(user.UserName)>0)
                    { 
                    await SignInAsync(user, model.RememberMe);
        ...
        public async Task<ActionResult> Login3(LoginViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                     UsuarioDAL x = new UsuarioDAL();
                    if (x.usuariopaciente(user.UserName) == 0 && x.usuariodoctor(user.UserName)==0)
                    {
                        await SignInAsync(user, model.RememberMe);
        ...
        // // GET: /Account/Login
        //[AllowAnonymous]
        //public ActionResult Login_dr(string returnUrl)
        //{
        //    ViewBag.ReturnUrl = returnUrl;
        //    return View();
        //}
        ...
        //[AllowAnonymous]
        //[ValidateAntiForgeryToken]
        //public async Task<ActionResult> Login_dr(LoginViewModel model, string returnUrl)
        //{
        //    if (ModelState.IsValid)
        //    {
        //        var user = await UserManager.FindAsync(model.UserName, model.Password);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Nuevo_usuario", "Usuario");
                    //Response.Redirect("~/Usuario/Nuevo_usuario");
                }
                else
                {
                    AddErrors(result);
